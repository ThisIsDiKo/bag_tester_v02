...
#define IND_DIG_1_PIN			GPIO_PIN_6
#define IND_DIG_2_PORT			GPIOB
#define IND_DIG_2_PIN			GPIO_PIN_5
...
#define DELAY_AFTER_ALIGNING_MS		10000 //10 min
#define CHECKING_DELAY_MS			10000 // 1 min
#define PRESSURE_ACCURACY_THRESHOLD		25
